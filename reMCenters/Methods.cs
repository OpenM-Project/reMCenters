...
namespace reMCenters
{
    ...
    var result=     await           reMCentersTask.CreateAndRunBasicOnThread(()=> client.DownloadFile($"https://raw.githubusercontent.com/{provider}/mcenterdlls/main/main", "tmp.txt"));
      ...
      =>
        ...
        public static  void InstallDll()
            ...
            retry:;
                ...
                var DllMethodAvailabitityCheckerTaskResult = reMCentersTask.CreateAndRunBasic(() => {
            ...
            bool DoAutoPatch(bool is64)
            {
                ...
                if (is64) { 
                    if(!reMCentersLibrary.DllMethod.Patchx64Dll()) return false; }
              return  reMCentersLibrary.DllMethod.Patchx86Dll();
            }
            ...
            public static void InstallDllAutoPatch()
            {
                ...
                if (!reMCentersTask.IsreMCentersLibraryPresent()) return;
            ...
            retry:;
                ...
                var DllMethodAvailabitityCheckerTaskResult = reMCentersTask.CreateAndRunBasic(() => {
                    var platform = 0;
                        ...
                        platform = reMCentersLibrary.DllMethod.GetPlatform(Dllx64);
                    ...
                    platform = reMCentersLibrary.DllMethod.GetPlatform(Dllx86);
